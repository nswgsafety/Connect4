...
class AI:
    ...
    def __init__(self, symbol, opponent_symbol, depth=HARD):
        self.symbol = symbol
    ...
    def get_move(self, board):
        ...
        # Easy mode: 40% chance of a random valid move
        if self.depth == self.EASY and random.random() < 0.40:
    ...
    def _check_win(self, grid, row, col, symbol):
        for dr, dc in [(0, 1), (1, 0), (1, 1), (1, -1)]:
            ...
            for d in (1, -1):
                ...
                while 0 <= r < Board.ROWS and 0 <= c < Board.COLS and grid[r][c] == symbol:
                    count += 1
                    r += dr * d
                    c += dc * d
    ...
    def _score_window(self, window):
        ...
        score = 0
        if s == 4:              score += 100
        elif s == 3 and e == 1: score += 5
        elif s == 2 and e == 2: score += 2
